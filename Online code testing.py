...
for root, dirs, files in os.walk(base_path):
    for file in files:
        ...
        if file.endswith(".csv"):
            ...
            filtered_df = df[(df['restimulus'] == 1) & (df['rerepetition'] == 1)]
            ...
            new_df.loc[0] = [rep1S1['emgIN0'],rep1S1['emgIN1'],rep1S1['emgIN2'],
                             rep1S1['emgIN3'],rep1S1['emgIN4'],rep1S1['emgIN5'],rep1S1['emgIN6'],
                             rep1S1['emgIN7'],rep1S1['emgIN8'],rep1S1['emgIN9'],1,1,1] #Stim #rep #excercise
